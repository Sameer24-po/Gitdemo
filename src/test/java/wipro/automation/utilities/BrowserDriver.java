...
public class BrowserDriver {
	...
	static String downloadDirectoryPath = "D:\\share\\UnpledgeProcessPart2\\EODHoldingReport";
...
//				    dCap.setCapability(InternetExplorerDriver.IE_ENSURE_CLEAN_SESSION, true);
					...
					if(hostName== null){
						System.setProperty("webdriver.ie.driver", BasePath.basedirpath+"\\Drivers\\IEDriverServer.exe");
				...
				case "chrome":
					...
					if(hostName== null){
						System.setProperty("webdriver.chrome.driver",  BasePath.basedirpath + "\\Drivers\\chromedriver.exe");
